...
for tr in soup.find_all('tr')[1:]:  # Skip header row
    ...
    for cell in cells:
        ...
        for a in links:
            ...
            # Replace the HTML link with markdown link in the cell text
            # This assumes link text appears exactly as in the HTML
            cell_text = cell_text.replace(link_text, md_link)
